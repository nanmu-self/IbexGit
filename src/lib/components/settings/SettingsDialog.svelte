<script lang="ts">
  ...
  import { app, net, ai, normalizeError, type CommitTemplate, type ConfigEntry, type CredentialEntry, type GitignoreFile, type KnownHost, type AiConfigDto } from "$lib/git";
